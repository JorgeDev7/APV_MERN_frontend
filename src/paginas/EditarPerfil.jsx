            ...
            <div className="flex justify-center">
                <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="submit" value="Guardar Cambios" className="bg-indigo-700 hover:bg-indigo-800 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5 cursor-pointer transition-colors" />
                    </form>
                </div>
            </div>
