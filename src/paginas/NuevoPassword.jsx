...
const NuevoPassword = () => {
    ...
    return (
        <>
            ...
            <div>
                <h1 className="text-indigo-600 font-black md:text-6xl text-5xl">Reestablece tu Password y no Pierdas Acceso a <span className="text-black">tus Pacientes</span></h1>
            </div>
                ...
                {tokenValido && (
                    <>
                        <form onSubmit={handleSubmit}>
                            ...
                            <input type="submit" value="Guardar Nuevo Password" className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 cursor-pointer hover:bg-indigo-800 md:w-auto" />
